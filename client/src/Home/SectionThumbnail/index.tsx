...
import { useScrollTriggerOnce } from '../../hook/useScrollTriger';
...
const SectionThumbnail: FC = () => {
    ...
    // parallax
    const triger = useScrollTriggerOnce(0);
    const view = useView();
        ...
        <section id='home' className='w-full flex flex-col justify-start items-center h-auto bg-tertiary-light pb-24 lg:flex-row-reverse lg:items-start line-black'>
            ...
            <div className='w-full flex flex-col justify-start items-start lg:pt-20'>
                ...
                <div ref={view.ref} className={clsx(
                    ...
                    (triger && view.inView) ? 'back-x' : 'start-to-left'
                )}>
...
const ThumbnailImage: FC = () => {
    ...
    return (
        <div ref={view.ref} className={clsx(
            'h-[36rem] w-full flex flex-row justify-center items-start relative pt-48 md:h-[60rem] lg:h-[40rem] transition-700',
