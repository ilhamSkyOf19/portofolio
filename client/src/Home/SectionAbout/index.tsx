...
const SectionAbout: FC = () => {
    ...
    return (
        <section id='about' className='w-full h-auto bg-tertiary-light py-16 px-3'>
            {/* title section */}
            ...
            <div className='w-full h-auto grid grid-cols-1 lg:grid-cols-3 lg:gap-8'>
                ...
                <div className='w-full h-auto lg:col-span-2 lg:pl-14 '>
                    {/* desc */}
                    <div id='resume' className='w-full flex flex-col justify-start items-start gap-4 pt-8 lg:pt-0'>
                        {/* title */}
