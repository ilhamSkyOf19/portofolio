...
const SectionAbout: FC = () => {
  ...
  return (
    <section
      id="aboutme"
      className="w-full h-auto bg-tertiary-light pt-16 pb-3 px-3"
    >
      {/* title section */}
      <ParallaxToRight>
        <TitleSection
          subJudul="A little more about me"
          title="about me"
        ...
        <ParallaxToTop>
          <div className="w-full h-[65vh] rounded-xl bg-tertiary-light relative p-3 md:h-[80vh] group lg:col-span-1 lg:h-[90vh]">
            ...
            <div className="w-full h-full rounded-xl bg-tertiary-dark relative overflow-hidden flex flex-col justify-end items-center">
              {/* img */}
              <div
                ref={refImg as RefObject<HTMLDivElement>}
                className="w-full h-full flex flex-col justify-end items-center transition-all duration-500 ease-in-out md:group-hover:scale-110"
              >
                <img
                  src={person}
                  alt="logo"
        ...
        <div className="w-full h-auto lg:col-span-2 lg:pl-14 ">
            ...
            <div className="w-full flex flex-col justify-start items-center gap-4 mt-2 md:items-left">
              <ParallaxToTop>
                <TextNormal classname="text-center leading-[1.7rem] md:text-left">
                  Hello! I'm Ilham Rohmatulloh, a 6th-semester undergraduate
                  student majoring in Computer Science, currently focusing on
                  developing my skills as a Junior Fullstack Developer.
                </TextNormal>
              </ParallaxToTop>

              <ParallaxToTop>
                <TextNormal classname="text-center leading-[1.7rem] md:text-left">
                  I have a strong interest in building web applications that are
                  lightweight, fast, and efficient. On the frontend, I work with
                  React and Tailwind CSS, while on the backend I utilize
                  Node.js, Bun, and Hono. For databases, I’m familiar with MySQL
                  and Prisma ORM.
                </TextNormal>
              </ParallaxToTop>
              ...
              <ParallaxToTop>
                <TextNormal classname="text-center leading-[1.7rem] md:text-left">
                  I'm passionate about learning new technologies, comfortable
                  working with Git, and committed to continuous growth and
                  contributing to development teams.
                </TextNormal>
              </ParallaxToTop>
            </div>
          </div>
          ...
          <ParallaxToTop>
            <div className="w-full flex-row justify-center items-center mt-12 lg:justify-start hidden">
              ...
              <button
                type="button"
                className="uppercase text-primary font-medium text-md bg-tertiary-light rounded-md py-4 px-12 relative transition-all duration-300 ease-in-out md:hover:md:-translate-y-1.5 cursor-pointer hover:bg-tertiary-dark"
              >
                {/* shadow */}
