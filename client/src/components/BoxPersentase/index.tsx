  ...
  return (
    <div className="w-full flex flex-col justify-start items-start">
      ...
      <div className="w-full flex flex-col justify-start items-start relative">
        {/* persentase value */}
        <div
          className="h-4.5 relative transition-all duration-[2200ms] ease-in-out"
          style={{ width: `${persentase ? persentase : 0}%` }}
        >
          <p className="text-sm font-normal text-text-primary text-right tracking-[0.1rem]">
            <CountUp
              start={0}
              end={persentase ? persentase : 0}
              duration={3}
              suffix="%"
            />
          </p>
        ...
        <div className="bg-gradient-to-t from-tertiary-light to-tertiary-dark h-3 w-full rounded-full p-[0.15rem]">
          <div
            className="bg-gradient-to-r from-purple-400 to-pink-600 h-full transition-all duration-[2200ms] ease-in-out rounded-full"
            style={{ width: `${persentase ? persentase : 0}%` }}
          />
        </div>
      </div>
